...
export const Dummy = () => {
  return (
    <DummyContainer>
      <DummyContentContainer>
        <DummyHeader>Zayna Token</DummyHeader>
        <DummySubHeader>Скоро будет запущен</DummySubHeader>
        <DummyText>Следите за обновлениями</DummyText>
        <DummyText>Больше информации в официальных каналах</DummyText>
        <DummySocialContainer>
          <DummySocial>
